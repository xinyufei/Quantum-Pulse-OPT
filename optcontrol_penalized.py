...
class Optcontrol_Penalized():
    ...
    def optimize_penalized(self):
        ...
        print("Final penalized value {}".format(self.cur_obj - 1 + fid), file=report)
        print("Final error {}".format(self.compute_penalty(self.u)), file=report)
